...
$dirasset = $dirasset[1];
$sitedir = "https://$_SERVER[HTTP_HOST]/$dirasset/assets/Cascade";
          ...
          <div class="navbarCollapseContainer">
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li class="myUTEPLink"><a href="https://servicedesk.utep.edu/WorkOrder.do?reqTemplate=3301" role="button" target="_blank">Contact us</a></li>

                <li class="myUTEPLink"><a href="logoff.php">Logout <span class="glyphicon glyphicon-log-out"></span></a></li>
              </ul>
