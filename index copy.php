    ...
    <div class="container">
      <div class="flexBoxWrapper">
        <div class="col-md-12">
          ...
          <div id="ndaModal" class="modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <br /><br />
                  ...
                  <div class="form-group">
                          <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                            <div class="btn-group mr-2" role="group" aria-label="First group">
                              <button class="btn btn-warning" value="DeleteFile.php?file=NDAs_dev\\', rawurlencode($row2['Filename']), '">Delete File </button>
                            </div>';
                            while ($row2 = $result2->fetch(PDO::FETCH_ASSOC)) {

                            echo '<div class="btn-group mr-2" role="group" aria-label="Second group">
                              <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#uploadDoc" value="https://orspweb2.utep.edu/displayndas_dev/UploadDocument.php?docket=' . $row['Docket'] . '">Upload File</button>
                            </div>
                          </div>
                        ...
                        <div class="form-group">
                          <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                            ...
                            <div class="btn-group mr-2" role="group" aria-label="Second group">
                              <button class="btn btn-danger" value="DeleteFile.php?file=', $row['Docket'], '"> Delete Docket</button>
